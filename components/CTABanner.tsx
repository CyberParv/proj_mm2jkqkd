...
export default function CTABanner({
  ...
  description = "Push harder, recover smarter, and train with the city’s most energetic coaches.",
  ...
  return (
    <section className="bg-primary py-16 md:py-20">
      <div className="container mx-auto max-w-4xl px-4 text-center">
        <h2 className="text-3xl font-bold text-primary-foreground md:text-4xl uppercase">{headline}</h2>
